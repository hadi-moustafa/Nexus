...
function getModel() {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](key).getGenerativeModel({
        model: "gemini-2.0-flash"
    });
}
async function generateDigest(articles, language = "en") {
    const langLabel = language === "ar" ? "Arabic" : language === "fr" ? "French" : "English";
    const articleList = articles.slice(0, 10).map((a, i)=>`${i + 1}. [${a.category.toUpperCase()}] ${a.title}\n   ${a.description ?? ""}`).join("\n\n");
...
//# sourceMappingURL=_0k3n.0p._.js.map