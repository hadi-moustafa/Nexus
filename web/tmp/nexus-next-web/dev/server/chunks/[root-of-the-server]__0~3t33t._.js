...
"[project]/src/app/api/v1/user/subscription/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServiceClient"])();
        const { data, error } = await supabase.from("subscriptions").select("id, plan, status, start_date, end_date, auto_renew, trial_ends_at").eq("user_id", auth.userId).single();
...
async function DELETE(request) {
    ...
    try {
        ...
        const { data: sub, error: fetchErr } = await supabase.from("subscriptions").select("id, status, stripe_customer_id, auto_renew").eq("user_id", auth.userId).single();
        if (fetchErr || !sub) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: {
                    code: "NOT_FOUND",
        ...
        if (sub.stripe_customer_id) {
            const stripeSubs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripe"].subscriptions.list({
                customer: sub.stripe_customer_id,
                status: "active",
                limit: 1
            });
            if (stripeSubs.data.length > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$stripe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripe"].subscriptions.update(stripeSubs.data[0].id, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0~3t33t._.js.map